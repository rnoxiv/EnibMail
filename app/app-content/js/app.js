...
.controller("WebmailCtrl", function($scope, $location, $http) {
	...
	getMails(); // Load all available items 
	function getMails(){  
		$http.post("ajax/getMails.php").success(function(data){
			$scope.mails = data;
		});
	};
	  
	$scope.addMail = function (mail) {
		$http.post("ajax/addMail.php?mail="+mail).success(function(data){
			getMails();
			$scope.itemInput = "";
		  });
	  };
	...
	$scope.deleteMail = function (mail) {
		...
		$http.post("ajax/deleteMail.php?mailID="+mail).success(function(data){
			getMails();
		  });
		}
	  };
	...
	$scope.clearMail = function () {
		if(confirm("Delete all checked mails?")){
		$http.post("ajax/clearMail.php").success(function(data){
			getMails();
		  });
		}
	  };
	...
	$scope.addCategory = function (category) {
		$http.post("ajax/addCategory.php?mail="+category).success(function(data){
			getCategories();
			$scope.itemInput = "";
		  });
	  };
	  
	$scope.deleteCategory = function (mail) {
		if(confirm("Are you sure to delete this category?")){
		$http.post("ajax/deleteCategory.php?categoryID="+category).success(function(data){
			getCategories();
		  });
		}
	  };
